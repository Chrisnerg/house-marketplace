...
const RentPage = () => {
  return (
    <div>
        <HeroSecondary bg_color={"bg-green-700"} title={"Rent a Home"} description={"Discover your next rental property"} searchCard={"true"}/>
        ...
        <Contents title={"Properties for Rent"} description={"rentals available"} pagination={"true"}/>
    </div>
  )
}
